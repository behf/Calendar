...
/**
 * Created by behzad on 11/25/2016.
 */
...
public class gDatePickerDialog extends Dialog {

    private Context Mcontex;

    private int NoOfYear = 40;

    public gDatePickerDialog(Context context, Calendar calendar,
        ...
        btnset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dtp.OnDoneButton(gDatePickerDialog.this, c);
            }
        });
        btncancel.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                dtp.OnCancelButton(gDatePickerDialog.this);
